...
<head>
    ...
    <meta name="Lesly Mercado" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 3675141</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> joshua.perez@cbtis89.edu.mx</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo $BDProductos[$n+2];  ?></h2>
												<p><?php echo $BDProductos [$n+1];?>Producto 1</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Agregar al Carrito</a>
											</div>
										</div>
								</div>								
